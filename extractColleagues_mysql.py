...
from tool import getHttpUa,getCursor,getResult,ChangeOrNot,editeHeader,getPage,cleanURL,writeList
...
sltDLNotCom = 'select id,colleage,name from dlurl1 where id>795 limit 2000'
Dir_path = 'E:/Code/Data/Error/'
httpError_path = 'httpError_'
sql_path = 'E:/Code/Data/insertSQL.csv'
...
def addInfo(nl,id):
    ...
    #insertValues = (nl[0],nl[1],nl[2])
    try:
        writeList(sql_path,[insertSQL])
    except Exception:
        print('write 2 list error,sql:'+insertSQL)
